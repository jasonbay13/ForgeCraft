...
namespace SMP.Generator
{
    public class NoisePerlin : Noise
    {
        ...
        public double GetNoise(double d, double d1, double d2)
        {
            double d3 = d + xCoord;
            double d4 = d1 + yCoord;
            double d5 = d2 + zCoord;
        ...
        {
            return GetNoise(d, d1, 0.0D);
        }

        public void GetNoise(double[] ad, double d, double d1, double d2, int i, int j, int k, double d3, double d4, double d5, double d6)
        {
            if(j == 1)
            {
                /*bool flag = false;
